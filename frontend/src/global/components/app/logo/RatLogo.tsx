...
export default function RatLogo(props: I_RatLogo) {
   ...
   return (
      <svg
         ...
         viewBox="0 0 264.725 264.725"
         xmlSpace="preserve"
      >
         <path
            d="M220.195,71.427c-0.589-7.654-9.135-15.619-17.979-16.209c-8.844-0.584-17.398,0.301-12.087,6.483
