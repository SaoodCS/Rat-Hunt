export class ArrayHelp {
  ...
  public static getArrOfValuesFromKey<T, K extends keyof T>(
    arr: T[],
    key: K
  ): T[K][] {
    return arr.map((obj) => obj[key]);
  }
  public static getObjWithKeyValuePair<T>(
    arr: T[],
    key: keyof T,
    value: T[keyof T]
  ): T {
  ...
  public static sort<T extends string[] | number[]>(
    arr: T,
    descending?: boolean
  ): T {
